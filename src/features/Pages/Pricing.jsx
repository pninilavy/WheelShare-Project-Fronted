  ...
  return (
    <>
      ...
      <div className="pricing-container">
        <CommercialCarCard
          carImage={"CommercialCarCard/images/car.png"}
          hourlyRate={"12.9  ₪"}
          dailyRate={"180  ₪"}
          seats={"5"}
          footerColor={"#00e079"}
        ...
        ></CommercialCarCard>
        <CommercialCarCard
          carImage={"CommercialCarCard/images/car2.png"}
          hourlyRate={"19.9  ₪"}
          dailyRate={"230  ₪"}
          seats={"7"}
          footerColor={"#f50057"}
        ...
        ></CommercialCarCard>
        <CommercialCarCard
          carImage={"CommercialCarCard/images/car3.png"}
          hourlyRate={"12.9  ₪"}
          dailyRate={"180  ₪"}
          seats={"5"}
          footerColor={"#2be1ef"}
        ...
        ></CommercialCarCard>
        <CommercialCarCard
          carImage={"CommercialCarCard/images/autocar.png"}
          hourlyRate={"12.9  ₪"}
          dailyRate={"180  ₪"}
          seats={"5"}
          footerColor={"#ffe000"}
